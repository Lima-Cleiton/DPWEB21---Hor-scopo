...
function conteudoEscorpiao(){
    document.getElementById("modalescorpiao").style.display = "block"
}

function fecharEscorpiao(){
    document.getElementById("modalescorpiao").style.display = "none"
}